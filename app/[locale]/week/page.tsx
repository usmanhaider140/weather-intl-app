...
export default async function Week() {
  ...
  return (
    <main>
      <h1 className="text-xs font-thin">This week&apos;s weather</h1>
          ...
          <section key={day.dateTime} className="py-5">
            ...
            <div>
              <div className="flex items-baseline gap-3">
                <p className="relative top-1 text-4xl">{day.conditionIcon}</p>
                <p className="text-3xl font-light">{day.condition}</p>
